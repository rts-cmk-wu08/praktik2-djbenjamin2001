...
const Meglere = async({searchParams}) => {
 ...
 <div className='bg-black'>
        <Image src="/banner.png" className='relative  bg-yellow-500 opacity-40'  width={1920} height={1080} alt=''></Image></div>
 ...
 <ul className='grid grid-cols-3 '>  
  ...
  <li  className='p-5 ' > 
<Link href={`/meglere/${meglere.id}`}> <Image src={meglere.image.url} width={meglere.image.width} height={meglere.image.height}></Image></Link>
